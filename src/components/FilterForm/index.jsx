...
import { FormSelect, FormSelectGroup } from "../Form";
...
export default function FilterForm() {
    ...
    return (
        <div className="filter-wrap">
            ...
            <div
                className={`filter ${open ? "show" : "hide"}`}
                id="home-filter"
            >
                <img src={ArrowUpIcon} alt="" className="filter__arrow" />
                <form action="" className="filter__form form">
                    ...
                    <div className="filter__row filter__content">
                        ...
                        <div className="filter__col">
                            <label
                                htmlFor=""
                                className="filter__heading form__label"
                            >
                                Brand
                            </label>
                            <div className="filter__form-group">
                                <div className="filter__form-search">
                                    <input
                                        onChange={() => {}}
                                        type="text"
                                        className="filter__form-search-input"
                                        placeholder="Search brand name"
                                    />
                                    <img
                                        src={SearchIcon}
                                        alt=""
                                        className="filter__form-serach-icon icon"
                                    />
                                </div>
                            </div>
                            <div className="filter__form-group">
                    ...
                    <div className="filter__row filter__footer">
                        <Button
                            className="filter__cancel btn--text"
                            onClick={() => setOpen(false)}
                        >
                            Cancel
                        </Button>
                        <Button className="filter__submit btn--primary">
                            Show Result
                        </Button>
                    </div>
                </form>
