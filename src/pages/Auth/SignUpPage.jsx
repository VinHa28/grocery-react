...
export default function SignUpPage() {
  ...
  return (
    <main className="auth">
      ...
      <div className={`auth__content ${isOpenContent ? 'show' : 'hide'}`} id="auth-content">
        <div className="auth__content-inner">
          ...
          <Form onSubmit={() => navigate('/')} className='auth__form'>
            ...
            <div className="form__group auth__btn-group">
              <Button type='submit' className="btn--primary auth__btn form__submit-btn">Sign Up</Button>
              <Button type='button' className="btn btn--outline auth__btn auth__btn--outline">
          ...
          <div className="auth__row">
            ...
            <Link to="/login" className="auth__link auth__link--larger">Sign In</Link>
          </div>
        </div>
      </div>
    </main>
