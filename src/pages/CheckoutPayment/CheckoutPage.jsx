    ...
    <main className="cart-main">
      <div className="container">
        ...
        <div className="cart-container">
          <BreadCrumbs className='cart-main__breadcrumbs' pathnames={pathnames} />
        </div>
              ...
              <div className="cart-info">
                ...
                <div className="user-address">
                  ...
                  <div className="user-address__list">
                    {dataSrc.listAddress.length === 0 ?
                      (<p className="user-address__message">
                        Not address yet.
                        <a href="#!" className="user-address__message-link">Add a new address?</a>
                      </p>) :
                      (
                        dataSrc.listAddress.map((item, index) => (
                          <AddressCard key={index} address={item.address} receiver={item.receiver} selected={item.selected} />
                        ))
                      )}
                  </div>
                </div>
                ...
                <div className="cart-info__separate"></div>
                <h3 className="cart-info__sub-heading">Items details</h3>
                    ...
                    <div className="col-8 col-xxl-7">
                      <div className="cart-info__continue">
                        <Link to="/" className="cart-info__continue-link">
                          <img src="./src/assets/icons/arrow-down-2.svg" alt="" className="cart-info__continue-icon icon" />
                          Continue Shopping
                        </Link>
                      </div>
                    </div>
